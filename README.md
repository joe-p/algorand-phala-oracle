...
- [Dan Boneh's ZK Whiteboard Sessions](https://www.youtube.com/watch?v=h-94UhJLeck) - Good resource on SNARKs
- [Succinct SP1 Documentation](https://docs.succinct.xyz/docs/sp1/introduction) - Good resource on zkVMs in general and Succinct's SP1 zkVM in particular
- [Phala: Complete Chain of Trust](https://docs.phala.com/phala-cloud/attestation/chain-of-trust) - Overview of the entire chain of trust for Phala, including TDX, TLS, and DNS
- [Understanding TDX Attestation Reports: A Developer's Guide](https://phala.com/posts/understanding-tdx-attestation-reports-a-developers-guide) - Good resource for understanding the Intel TDX attestation flow and how it works with Phala
